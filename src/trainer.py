...
from transformers.utils import SAFE_WEIGHTS_NAME, WEIGHTS_NAME, is_safetensors_available, strtobool
...
class CollieTrainer(Seq2SeqTrainer):
    ...
    def get_optimizer_cls_and_kwargs(args: TrainingArguments) -> Tuple[Any, Any]:
        ...
        Ensures that all the numeric optimizer arguments are cast to float, deepspeed and FSDP fail due
        to some of the arguments being strings.

        More info here: https://github.com/microsoft/DeepSpeed/issues/4024
        ...
        optimizer_kwargs = {"lr": float(args.learning_rate)}
