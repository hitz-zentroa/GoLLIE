...
class E3CDatasetLoader(DatasetLoader):
    """
    A `DatasetLoader` for the E3C dataset.
...
class E3CSampler(Sampler):
    """
    A data `Sampler` for the E3C dataset.
    ...
    def __init__(
        self,
        dataset_loader: E3CDatasetLoader,
        task: str = None,
        split: str = "train",
        ...
        **kwargs,
        ...
        assert task in [
            "NER",
        ], f"E3C Disease only supports NER task. {task} is not supported."
