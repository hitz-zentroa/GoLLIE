GUIDELINES = {
    "mit_rating": {
        "en": [
            ...
            " for example in the sentence 'good burger', 'good' is considered a rating for the burger. Examples: good,"
            " best, nice, great, five star, highest rated, highly rated, 5 star, good reviews, 4 star."
        ]
    },
    "mit_amenity": {
        "en": [
            ...
            " Examples: kid friendly, carry out, take out, buffet, outdoor dining, romantic, valet parking, parking,"
            " reservations, smoking area."
        ]
    },
    "mit_location": {
        "en": [
            ...
            " a place associated with the restaurant. Examples: nearby, closest, nearest, around here, in the area,"
            " close by, near here, within 5 miles, local, in town."
        ]
    },
    "mit_restaurantname": {
        "en": [
            ...
            " establishment. Examples: mcdonalds, burger king, wendys, taco bell, olive garden, dennys, subway, pizza"
            " hut, applebees, red lobster."
        ]
    },
    "mit_price": {
        "en": [
            ...
            " descriptions (e.g., affordable, expensive). Examples: cheap, expensive, reasonably, cheapest,"
            " affordable, inexpensive, moderately, good, reasonable, great. "
        ]
    },
    "mit_hours": {
        "en": [
            ...
            " 11pm), and general time descriptions (e.g., late at night, open right now). Examples: lunch, open,"
            " dinner, breakfast, late night, tonight, open late, close, open right now, still open."
        ]
    },
    "mit_dish": {
        "en": [
            ...
            " and served. Examples: pizza, sushi, steak, burger, ice cream, tacos, hamburger, sandwich, burgers, beer."
        ]
    },
    "mit_cuisine": {
        "en": [
            "Refers to any specific style or type of food associated with a particular culture, region, or culinary"
            " tradition. It includes various types of cuisines, such as chinese, italian, mexican, fast food, seafood,"
            " indian, japanese, pizza, sushi, vegan."
        ]
    },
}
