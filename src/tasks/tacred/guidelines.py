GUIDELINES = {
    "rams_organizationalternatename": {
        "en": [
    ...
    "rams_organizationcityofheadquarters": {
        "en": [
    ...
    "rams_organizationcountryofheadquarters": {
        "en": [
    ...
    "rams_organizationdatedissolved": {
        "en": [
    ...
    "rams_organizationnumberofemployeesmembers": {
        "en": [
    ...
    "rams_organizationpoliticalreligiousaffiliation": {
        "en": [
    ...
    "rams_organizationstateorprovinceofheadquarters": {
        "en": [
    ...
    "rams_organizationtopmembersemployees": {
        "en": [
    ...
    "rams_personstateorprovinceofbirth": {
        "en": [
    ...
    "rams_personstateorprovinceofdeath": {
        "en": [
    ...
    "rams_personstateorprovinceofresidence": {
        "en": [
