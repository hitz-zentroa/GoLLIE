#!/bin/bash
#SBATCH --job-name=CoLLIE7B_lora4_base
#SBATCH --cpus-per-task=16
#SBATCH --gres=gpu:1
#SBATCH --mem=128G
#SBATCH --output=.slurm/CoLLIE7B_lora_4_base.out.txt
#SBATCH --error=.slurm/CoLLIE7B_lora_4_base.err.txt
...
python3 -m src.run ${CONFIGS_FOLDER}/CoLLIE-7B_lora4_baseline.yaml
