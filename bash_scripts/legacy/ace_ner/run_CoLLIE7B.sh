#!/bin/bash
#SBATCH --job-name=CoLLIE7B-ace-ner
#SBATCH --cpus-per-task=16
#SBATCH --gres=gpu:1
#SBATCH --mem=128G
#SBATCH --output=.slurm/CoLLIE7B-ace-ner.out.txt
#SBATCH --error=.slurm/CoLLIE7B-ace-ner.err.txt
...
python3 src/run.py ${CONFIGS_FOLDER}/CoLLIE-7B.yaml
