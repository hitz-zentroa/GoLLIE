#!/bin/bash
#SBATCH --job-name=CoLLIE7B_hparams-ace-ner
#SBATCH --cpus-per-task=16
#SBATCH --gres=gpu:1
#SBATCH --mem=128G
#SBATCH --output=.slurm/CoLLIE7B_hparams-ace-ner.out
#SBATCH --error=.slurm/CoLLIE7B_hparams-ace-ner.err
...
CONFIGS_FOLDER="configs/model_configs/ace_entities/hparams"
