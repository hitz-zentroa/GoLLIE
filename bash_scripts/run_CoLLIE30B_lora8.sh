#!/bin/bash
#SBATCH --job-name=CoLLIE30B_lora8
#SBATCH --cpus-per-task=16
#SBATCH --gres=gpu:1
#SBATCH --mem=128G
#SBATCH --output=.slurm/CoLLIE30B_lora_8.out.txt
#SBATCH --error=.slurm/CoLLIE30B_lora_8.err.txt
...
python3 -m src.run ${CONFIGS_FOLDER}/CoLLIE-30B_lora8.yaml
