#!/bin/bash
#SBATCH --job-name=CoLLIE7B_lora8_8bits_optim
#SBATCH --cpus-per-task=16
#SBATCH --gres=gpu:1
#SBATCH --mem=128G
#SBATCH --output=.slurm/CoLLIE7B_lora_8_8bits_optim.out.txt
#SBATCH --error=.slurm/CoLLIE7B_lora_8_8bits_optim.err.txt
...
python3 -m src.run ${CONFIGS_FOLDER}/CoLLIE-7B_lora8_8bits_optim.yaml
