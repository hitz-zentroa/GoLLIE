...
torchrun --standalone --master_port 37227 --nproc_per_node=8 src/run.py configs/model_configs/GoLLIE-7B_Mistral_BS128_R128.yaml
torchrun --standalone --master_port 37227 --nproc_per_node=8 src/run.py configs/model_configs/eval/GoLLIE-7B_Mistral_BS128_R128.yaml
