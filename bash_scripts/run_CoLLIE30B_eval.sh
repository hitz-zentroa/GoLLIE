#!/bin/bash
#SBATCH --job-name=CoLLIE30B
#SBATCH --cpus-per-task=16
#SBATCH --gres=gpu:1
#SBATCH --mem=128G
#SBATCH --output=.slurm/CoLLIE30B.out.txt
#SBATCH --error=.slurm/CoLLIE30B.err.txt
...
python3 -m src.run  ${CONFIGS_FOLDER}/CoLLIE-30B_eval.yaml
