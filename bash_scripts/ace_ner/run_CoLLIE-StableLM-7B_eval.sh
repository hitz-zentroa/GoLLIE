#!/bin/bash
#SBATCH --job-name=CoLLIE-StableLM-7B-ace-ner
#SBATCH --cpus-per-task=16
#SBATCH --gres=gpu:1
#SBATCH --mem=128G
#SBATCH --output=.slurm/CoLLIE-StableLM-7B-ace-ner.out.txt
#SBATCH --error=.slurm/CoLLIE-StableLM-7B-ace-ner.err.txt
...
python3 -m src.run  ${CONFIGS_FOLDER}/StableLM-7B_eval.yaml
