...
python3 -m src.run_flash_att ${CONFIGS_FOLDER}/run_CoLLIE13B_LLAMA2_lora4_flash.sh
python3 -m src.run_flash${CONFIGS_FOLDER}/run_CoLLIE13B_LLAMA2_lora4_flash_eval.sh
