...
torchrun --standalone --master_port 37229 --nproc_per_node=4 src/run.py configs/model_configs/GoLLIE-YI34B_BS128_R128.yaml
torchrun --standalone --master_port 37229 --nproc_per_node=4 src/run.py configs/eval/model_configs/GoLLIE-YI34B_BS128_R128.yaml
