...
accelerate launch --num_processes=8 --deepspeed_config_file configs/deepspeed_configs/deepspeed_zero3.json --zero3_init_flag false src/run.py configs/model_configs/eval/GoLLIE-YI34B_BS128_R128.yaml
